...
def start_process(subject_name, buggy_versions_set):
    ...
    # 5. distribute config directory to each machine-core
    distribute_config_dir(configs, subject_working_dir, distribution_machineCore2bugsList)
...
def distribute_config_dir(configs, subject_working_dir, distribution_machineCore2bugsList):
    global use_distributed_machines

    if configs[use_distributed_machines] == True:
        distribute_config_dir_distributed_machines(configs, subject_working_dir, distribution_machineCore2bugsList)


def distribute_config_dir_distributed_machines(configs, subject_working_dir, distribution_machineCore2bugsList):
