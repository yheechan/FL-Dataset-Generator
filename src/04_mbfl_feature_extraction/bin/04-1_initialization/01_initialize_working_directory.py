...
def initialize_working_directory(configs, subject_name):
    global mbfl_feature_extraction_dir, user_configs_dir, subjects_dir, external_tools_dir

    # Create working directory
    working_dir = mbfl_feature_extraction_dir / f'{subject_name}-working_directory'
    ...
    # copy music executable to external_tools directory
    musicup_exec = external_tools_dir / 'MUSICUP/music'
    assert musicup_exec.exists(), 'Extractor executable does not exist'
