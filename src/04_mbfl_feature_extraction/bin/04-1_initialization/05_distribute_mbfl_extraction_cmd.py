...
def start_process(subject_name):
    ...
    distribute_mbfl_extraction_cmd(configs, subject_working_dir, distribution_machineCore2bugsList)
...
def distribute_mbfl_extraction_cmd(configs, subject_working_dir, distribution_machineCore2bugsList):
    global use_distributed_machines

    if configs[use_distributed_machines] == True:
        distribute_mbfl_extraction_cmd_distributed_machines(configs, subject_working_dir, distribution_machineCore2bugsList)


def distribute_mbfl_extraction_cmd_distributed_machines(configs, subject_working_dir, distribution_machineCore2bugsList):
    global bin_dir
