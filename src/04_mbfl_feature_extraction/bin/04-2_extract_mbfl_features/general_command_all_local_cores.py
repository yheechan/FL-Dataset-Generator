...
extract_mbfl_feature_cmd_dir = bin_dir.parent

# General directories
src_dir = extract_mbfl_feature_cmd_dir.parent
...
def start_process(subject_name):
    ...
    subject_working_dir = extract_mbfl_feature_cmd_dir / f"{subject_name}-working_directory"
