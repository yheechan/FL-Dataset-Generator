...
def initialize_working_directory(configs, subject_name):
    global select_usable_buggy_versions_dir, user_configs_dir, subjects_dir, external_tools_dir

    # Create working directory
    working_dir = select_usable_buggy_versions_dir / f'{subject_name}-working_directory'
